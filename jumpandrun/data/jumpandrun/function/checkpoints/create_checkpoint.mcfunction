...
execute align xyz run summon armor_stand ~0.5 ~0.2 ~0.5 {CustomName:{"text":"Checkpoint","color":"gold","bold":true},CustomNameVisible:1b,NoGravity:1b,Marker:1b,Invisible:1b,Small:1b,Tags:["checkpoint","checkpoint_new"]}
