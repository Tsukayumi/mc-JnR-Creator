...
execute align xyz run summon armor_stand ~0.5 ~0.2 ~0.5 {CustomNameVisible:1b,NoGravity:1b,Marker:1b,Invisible:1b,Small:1b,Tags:["end"],Health:20f,AbsorptionAmount:999f,CustomName:{"text":"End","color":"gold","bold":true}}
